import ImageGalleryOne from '@public/assets/images/gallery/lucipara-1.jpg';
...
export const EVENT_TITLE_FULL = 'Lucipara Suanggi Dive Trip with Majestic Voyager';
...
export const EVENT_TITLE = 'Lucipara Dive Trip - Majestic Voyager' || '';
...
export const EVENT_OVERVIEW = 'Escape the well-trodden dive paths and embark on an extraordinary adventure to the Lucipara Suanggi archipelago, a remote chain of islands in Indonesia. Explore this underwater frontier aboard a luxurious liveaboard, diving into pristine reefs teeming with marine life and encountering rarely seen wonders.';
