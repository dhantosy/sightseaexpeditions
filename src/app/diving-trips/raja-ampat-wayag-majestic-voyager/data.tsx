import ImageGalleryOne from '@public/assets/images/gallery/wayag-1.jpg';
...
export const EVENT_TITLE_FULL = 'Wayag Dive Trip with Majestic Voyager';
...
export const EVENT_TITLE = 'Wayag Dive Trip - Majestic Voyager' || '';
...
export const EVENT_OVERVIEW = 'Embark on a voyage of unparalleled beauty on a liveaboard diving trip to Wayag, nestled within the heart of Raja Ampat, Indonesia. This remote archipelago boasts some of the world`s most breathtaking scenery and a kaleidoscope of marine life, promising an unforgettable diving adventure.';
