import ImageGalleryOne from '@public/assets/images/gallery/maldives-2.jpg';
...
export const EVENT_TITLE_FULL = 'Lebaran Escape Best of Maldives Dive Trip with MYNA-1';
...
export const EVENT_TITLE = 'Lebaran Escape Maldives - MYNA-1' || '';
