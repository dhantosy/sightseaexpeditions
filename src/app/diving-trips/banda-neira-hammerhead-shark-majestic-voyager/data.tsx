...
export const EVENT_TITLE_FULL = 'Banda Neira Hammerhead Shark Dive Trip with Majestic Voyager';
...
export const EVENT_TITLE = 'Bandar Neira Hammerhead Shark Dive - Majestic Voyager' || '';
