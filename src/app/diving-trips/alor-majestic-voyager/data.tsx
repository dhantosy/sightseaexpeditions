import ImageGalleryOne from '@public/assets/images/gallery/alor-5.jpg';
...
export const EVENT_TITLE_FULL = 'Alor Dive Trip with Majestic Voyager';
...
export const EVENT_TITLE = 'Alor Dive Trip - Majestic Voyager' || '';
...
export const EVENT_OVERVIEW = 'Alor, a volcanic jewel in Indonesia`s Coral Triangle, beckons divers with a kaleidoscope of underwater wonders best explored on a luxurious liveaboard adventure.Escape the crowds and dive deeper into a world teeming with life.';
