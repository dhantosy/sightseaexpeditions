...
export const EVENT_TITLE_FULL = 'Deep South Maldives Dive Trip with Maldives Mosaique';
...
export const EVENT_TITLE = 'Deep South Maldives Dive Trip' || '';
...
export const EVENT_OVERVIEW = 'Escape the beaten path and delve into the pristine paradise of the Maldivian Southern Atolls on a luxurious liveaboard diving adventure.  Aboard your comfortable vessel, you`ll navigate a remote archipelago teeming with vibrant marine life, untouched reefs, and exhilarating encounters.';
