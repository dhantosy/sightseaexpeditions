import ImageGalleryOne from '@public/assets/images/gallery/palawan-2.jpg';
...
export const EVENT_TITLE_FULL = 'Tubbataha Dive Trip with MY Resolute';
...
export const EVENT_TITLE = 'Tubbataha Dive Trip' || '';
