import ImageGalleryOne from '@public/assets/images/gallery/banda-neira-1.jpg';
...
export const EVENT_TITLE_FULL = 'Banda Neira Dive Trip with Majestic Voyager';
...
export const EVENT_TITLE = 'Banda Neira Dive Trip - Majestic Voyager' || '';
