import ImageGalleryOne from '@public/assets/images/gallery/raja-ampat-3.jpg';
...
export const EVENT_TITLE_FULL = 'Lebaran Escape Misool Dive Trip with Majestic Voyager';
...
export const EVENT_TITLE = 'Lebaran Escape Misool - Majestic Voyager' || '';
...
export const EVENT_OVERVIEW = 'Embark on a voyage of discovery to Misool, the heart of Raja Ampat and a crown jewel of Indonesian diving. A Misool liveaboard adventure unlocks a world of unparalleled biodiversity, breathtaking underwater landscapes, and encounters that will leave you speechless.';
