...
export const EVENT_TITLE_FULL = 'Komodo Dive Trip with Majestic Voyager';
...
export const EVENT_TITLE = 'Komodo Dive Trip - Majestic Voyager' || '';
...
export const EVENT_OVERVIEW = 'Embark on an unforgettable adventure with a liveaboard diving trip to Komodo National Park, a diver`s paradise teeming with life and natural wonders. Explore legendary dive sites, encounter mesmerizing marine megafauna, and witness the awe - inspiring Komodo dragons on this ultimate diving expedition.';
