import ImageGalleryOne from '@public/assets/images/gallery/ring-of-fire.jpg';
...
export const EVENT_TITLE_FULL = 'Ring of Fire - Forgotten Island Dive Trip with Oceanix Voyager';
...
export const EVENT_TITLE = 'Ring of Fire Dive Trip September - Oceanix Voyager' || '';
...
export const EVENT_OVERVIEW = 'Indonesia`s fiery heart, the Ring of Fire, beckons with a liveaboard diving adventure unlike any other.Explore a volcanic wonderland where dramatic landscapes meet a kaleidoscope of marine life, all from the comfort of a luxurious liveaboard vessel.';
