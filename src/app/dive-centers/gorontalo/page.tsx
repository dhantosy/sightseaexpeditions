...
export default function DiveCenterAlorPage() {
  ...
  const filterDivePackages = diveCenterData.filter((data) => data.type === 'dive_package');
        ...
        <div className='flex flex-col lg:flex-row'>
          <div className='basis-full lg:basis-2/3 flex-shrink-0 flex flex-col gap-5'>
            <AccordionTable
              isExpand
              title='Dive Package'
              tableTitle={['Program', 'Total Dive', 'Minimum Person', 'Price per Person']}
