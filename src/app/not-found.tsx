    ...
    <main className='mt-28 lg:mt-40'>
      <section className='relative container my-10 lg:my-12 px-4 lg:px-8'>
        <div className='max-w-4xl mx-auto my-20 text-center'>
          <div className='text-6xl lg:text-8xl font-montserrat uppercase font-bold'>404</div>
          <div className='text-2xl lg:text-4xl font-semibold mt-3 mb-10 lg:mb-12'>Page Not Found</div>
