        ...
        <div className='flex flex-col lg:flex-row'>
          <div className='basis-full lg:basis-2/3 shrink-0 grow-0 flex flex-col gap-5 relative'>
            <AccordionContent title='Overview' isExpand>
              <p className='opacity-70 mb-4'>Derya is derivied from the persian (Daryã) meaning ocean and sea. Traditional phinishi boat with modern concept for leisure. Designed for 10 person with 4 cabins and many spaces to relax or gather with your family and friends. Let’s enjoy the mesmerizing island of komodo with us.</p>
            </AccordionContent>
