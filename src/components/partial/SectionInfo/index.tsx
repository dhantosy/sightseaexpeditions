...
export default function SectionInfo({
  ...
  return (
    <section className='my-12 md:my-16 relative'>
      ...
      <div className='container relative px-4 text-center lg:px-8'>
        <div className='flex flex-col'>
          ...
          <div className='flex relative gap-6 md:gap-10 max-w-5xl w-full mx-auto flex-nowrap overflow-x-auto my-7 border border-slate-200 rounded-2xl p-4'>
            {images.map(({ img, imgAlt, blurDataUrl }) => {
              return (
                <div key={imgAlt} className='flex flex-shrink-0 flex-[240px] relative z-10 rounded-2xl overflow-hidden w-full h-80 md:pb-[40%] shadow-xl'>
                  <Image
                    src={img}
                    alt={imgAlt}
